...
## 1\. La Escena Inicial: La Muerte en la Piedad
...
- Tirada de Cordura (SAN): Ver a Sor Juana muerta de forma tan grotesca exige una tirada de 1/1D3 SAN.
...
## 2\. La Criatura Esquelética Despierta
...
|---|---|
| PV | 12 |
| DB | +1D4 (Debido a su fuerza mágica y TAM) |
| Armadura | 3 (Huesos duros y magia protectora) |
| SAN | 0/1D4 (Ver el movimiento antinatural) |

- Tirada de Cordura (SAN): La revelación de que la estatua era una criatura exige otra tirada de 0/1D4 SAN.

## 3\. Mecánicas de Combate Clave

La Criatura Esquelética es la centinela de Inés, programada para evitar la huida y neutralizar amenazas.

1. Primer Movimiento: Atrapar al Más Cercano (Sujetar)
...
- Éxito: Si la tirada es exitosa, el jugador queda sujeto (grappled).
    - El jugador solo puede intentar zafarse (tirada opuesta de FUE o Lucha) o atacar con un Dado de Penalización (2D100, usando el resultado más alto).
...
2. Acción Secundaria: Bloqueo de la Entrada (Bloquear)
